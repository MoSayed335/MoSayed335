...
```yaml
> initializing_developer_profile.exe
...
> boot successful. profile loaded ✅
```
...
### 🔭 Building
Backend systems & REST APIs with ASP.NET Core
...
### 🤝 Open To
Backend Developer roles & collaborations
...
[![Download CV](https://img.shields.io/badge/DOWNLOAD-CV-b983ff?style=for-the-badge&logo=readdotcv&logoColor=white&labelColor=000000)](https://github.com/MoSayed335/CV/blob/main/Mohamed_Sayed_Abdelkader(BackendDotnet).pdf)
